...
public interface MonitordataRepository extends ElasticsearchRepository<Monitordata, String> {
	...
	@Query(value="{\"filtered\": {\"query\": {\"simple_query_string\" : {\"fields\" : [\"path\"],\"query\" : \"/html\"}},\"filter\": {\"and\": [{\"range\" : {\"@timestamp\" : {\"gte\": \"2015-01-13T10:55:28+01:00\",\"lte\": \"now\",\"time_zone\": \"+01:00\"}}},{\"term\": {\"container_name\": \"?0\"}}]}}}")
	public List<Monitordata> findCustom(String container, Pageable sort);

	@Query(value="{\"filtered\": {\"query\": {\"simple_query_string\" : {\"fields\" : [\"?2\"],\"query\" : \"?1\"}},\"filter\": {\"and\": [{\"range\" : {\"@timestamp\" : {\"gte\": \"2015-01-13T10:55:28+01:00\",\"lte\": \"now\",\"time_zone\": \"+01:00\"}}},{\"term\": {\"container_name\": \"?0\"}}]}}}")
