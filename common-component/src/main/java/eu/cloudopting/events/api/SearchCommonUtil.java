package eu.cloudopting.events.api;
...
import eu.cloudopting.events.api.constants.SearchField;
...
public final class SearchCommonUtil {
    ...
    public static List<ImmutableTriple<String, ClientOperation, ?>> uriParamsToConstraints(
    ...
    public static boolean validateParameters(final Set<String> paramKeys) {
        return !paramKeys.retainAll(Lists.newArrayList(// @formatter:off
                                                       ...
                                                       QueryConstants.DESCRIPTION_NEG));
    }
