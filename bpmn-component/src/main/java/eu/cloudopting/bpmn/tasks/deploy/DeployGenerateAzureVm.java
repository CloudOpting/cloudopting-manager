...
@Service
public class DeployGenerateAzureVm implements JavaDelegate {
	private final Logger log = LoggerFactory.getLogger(DeployGenerateAzureVm.class);
	@Autowired
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		log.debug("in DeployGenerateAzureVm");
