...
import eu.cloudopting.domain.PersistentToken;
...
public class AccountResource {
    ...
    public ResponseEntity<String> registerAccount(@Valid @RequestBody final UserDTO userDTO, HttpServletRequest request) {
